"""Configuration for the rebuilt Food Freshness Monitoring System."""
...
# MQTT (ESP <-> Raspberry Pi)
MQTT_BROKER = os.getenv("FOODMON_MQTT_BROKER", "localhost")
MQTT_PORT = int(os.getenv("FOODMON_MQTT_PORT", "1883"))
MQTT_KEEPALIVE = 60
...
CLOUD_PROVIDER = os.getenv("FOODMON_CLOUD_PROVIDER", "firebase")  # firebase | generic
FIREBASE_DB_URL = os.getenv("FOODMON_FIREBASE_DB_URL", "")  # e.g. https://xxx-default-rtdb.firebaseio.com
...
ACTUATOR_CONTROL_MODE = os.getenv("FOODMON_ACTUATOR_CONTROL_MODE", "esp").lower()  # esp | pi
ESP_ACTUATOR_COMMAND_TOPIC = os.getenv("FOODMON_ESP_ACTUATOR_COMMAND_TOPIC", "foodmon/control/actuators")
